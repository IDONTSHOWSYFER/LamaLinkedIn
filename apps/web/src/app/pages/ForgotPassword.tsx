...
import { Mail, ArrowRight, Zap, ArrowLeft, CheckCircle } from 'lucide-react';
...
export function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The endpoint never reveals whether an account exists, so even on an
      // unexpected error we show the same neutral confirmation.
      setSent(true);
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="flex-1 flex items-center justify-center p-4 py-16 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-adaptive mb-2">Mot de passe oublié</h1>
          <p className="text-neutral-400">Recevez un lien de réinitialisation par email</p>
        </div>
        ...
        <GlassCard className="p-8 border-white/20 relative">
          ...
          {sent ? (
            <div className="text-center py-4">
              ...
              <p className="text-adaptive font-medium mb-2">Vérifiez votre boîte mail</p>
              <p className="text-neutral-400 text-sm mb-6">
                Si un compte est associé à <strong>{email}</strong>, vous recevrez un lien pour
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      Envoyer le lien <ArrowRight className="ml-2" size={20} />
                    </>
                  )}
                </Button>
              </form>
              ...
              <div className="mt-8 pt-6 border-t border-white/10 text-center">
                <Link
                  to="/login"
                  className="inline-flex items-center gap-1.5 text-neutral-400 text-sm hover:text-primary transition-colors"
                >
