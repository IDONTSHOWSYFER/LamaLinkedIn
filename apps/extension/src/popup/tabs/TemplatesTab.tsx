...
import { Copy, FileText, Search, Check, Upload, MessageSquare, Heart, UserPlus, Award, Lightbulb, Handshake } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        {filtered.map((template) => {
          ...
          return (
            <Card key={template.id} padding="sm" hover>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 h-8 bg-primary hover:bg-primary-hover text-primary-foreground text-xs font-semibold rounded-lg transition-all flex items-center justify-center gap-1 shadow-sm"
                >
